...
> **当前状态（2026-06）**：协议工作名 **NovaPanda** 已定稿；**商标注册进行中 / 尚未完成**；**官方域名尚未注册**；仓库为本地参考实现，**尚未对外高调发布**。
>
...
| 项 | 状态 | 动作 |
|----|:----:|------|
| 文字商标近似检索（NovaPanda + 相关尼斯类） | ☐ | 商标局官网或代理查询；记录冲突风险 |
...
> NovaPanda 为本项目协议工作名。商标注册与官方域名筹备中；未暗示与任何第三方清算/LLM/能源伙伴的官方背书关系。
...
| PyPI / npm 包名 `@novapanda/*` 检索 | ☐ | 与 `sdk/typescript` 包名一致 |
...
- 与 x402/AP2 **分层**：它们在清算/授权；NovaPanda 管可验证交割与信誉

**不要说（除非事实已成立）：**

- 「已对接某某持牌清算 / 某某大厂官方 sandbox」
- 「NovaPanda® 官方认证」——无注册商标与认证流程前
